...
protected:
  ...
  std::unique_ptr<MySQL_ParamBind> param_bind;
  ...
  std::unique_ptr<MySQL_PreparedResultSetMetaData> res_meta;
  std::unique_ptr<MySQL_ParameterMetaData> param_meta;
...
public:
 ...
 int setQueryAttrDateTime(const sql::SQLString &name,
                          const sql::SQLString &value) override;
 ...
 int setQueryAttrString(const sql::SQLString &name,
                        const sql::SQLString &value) override;
